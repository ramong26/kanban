...
export default function Card({ item, index }: CardComponentProps) {
  return (
    <Draggable draggableId={item.id} index={index}>
      {(provided, snapshot) => (
        <div
          ...
          className={`bg-white rounded-lg shadow-md p-4 border border-gray-100 hover:shadow-lg transition-shadow cursor-grab active:cursor-grabbing ${
